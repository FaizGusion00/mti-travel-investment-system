...
<body class="min-h-screen">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="card rounded-xl p-6 mb-8">
            ...
            <p class="mb-4">Welcome to the Meta Travel International API documentation. This API provides access to the MTI platform's features, including user management, profile management, and network/referral system.</p>
